...
# READ – zabezpieczony przed IDOR
@app.route('/products/<int:product_id>', methods=['GET'])
@jwt_required
def get_product(product_id):
    # Filtrujemy jednocześnie po id i owner_id, by nie ujawniać cudzych rekordów
    p = Product.query.filter_by(id=product_id, owner_id=g.current_user.id).first_or_404()
